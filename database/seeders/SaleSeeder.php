    ...
    public function run(): void
    {
        ...
        $salesData = [
            [
                ...
                'payment' => 'cash', 'payment_received_at' => '2026-04-05 14:30:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'card', 'payment_received_at' => '2026-04-10 11:15:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'transfer', 'payment_received_at' => '2026-04-15 16:45:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'installment', 'payment_received_at' => null,
                'items' => [
                    ['product' => 'iPhone 15 Pro Max', 'qty' => 1, 'price' => 1299.00],
                ],
            ],
            [
                ...
                'payment' => 'cash', 'payment_received_at' => '2026-05-05 13:00:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'card', 'payment_received_at' => '2026-05-10 10:30:00',
                'items' => [
                    ['product' => 'iPhone 15', 'qty' => 1, 'price' => 999.00],
            ...
            [
                ...
                'payment' => 'cash', 'payment_received_at' => '2026-05-18 15:20:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'card', 'payment_received_at' => '2026-05-22 12:45:00',
                'items' => [
            ...
            [
                ...
                'payment' => 'transfer', 'payment_received_at' => '2026-06-12 09:30:00',
                'items' => [
                    ['product' => 'iPhone 15 Pro Max', 'qty' => 1, 'price' => 1299.00],
                    ['product' => 'شاحن سريع USB-C', 'qty' => 1, 'price' => 19.99],
                ],
            ...
            foreach ($data['items'] as $item) {
                ...
                for ($i = 0; $i < $item['qty']; $i++) {
                    ...
                    if ($stockItem) {
                        ...
                        $totalCost += (float) $stockItem->cost_price;
                    }
                }

                if ($totalCost > 0) {
                    $saleItem->updateQuietly(['total_cost' => $totalCost]);
                }
            }
        }
    }
