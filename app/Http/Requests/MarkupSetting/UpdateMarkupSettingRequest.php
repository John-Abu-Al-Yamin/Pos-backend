...
class UpdateMarkupSettingRequest extends BaseApiRequest
{
    ...
    {
        return [
            'product_type' => 'required|string|in:new_mobile,used_mobile,accessory,spare_part|unique:markup_settings,product_type,' . $this->route('id'),
