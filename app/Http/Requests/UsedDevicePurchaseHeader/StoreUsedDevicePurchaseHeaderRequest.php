...
class StoreUsedDevicePurchaseHeaderRequest extends BaseApiRequest
{
    /**
    ...
    {
        return [
            'purchase_number' => 'required|string|max:255|unique:used_device_purchase_headers',
    ...
    {
        return [
            'purchase_number.required' => 'رقم الشراء مطلوب.',
